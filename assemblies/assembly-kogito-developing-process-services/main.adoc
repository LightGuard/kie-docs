...
include::modules/bpmn/con-bpmn.adoc[leveloffset=+1]
include::modules/bpmn/ref-bpmn-model-example.adoc[leveloffset=+2]
include::modules/bpmn/ref-bpmn-support.adoc[leveloffset=+2]
include::modules/bpmn/ref-bpmn-start-events.adoc[leveloffset=+2]
include::modules/bpmn/ref-bpmn-intermediate-events.adoc[leveloffset=+2]
include::modules/bpmn/ref-bpmn-end-events.adoc[leveloffset=+2]
include::modules/bpmn/ref-bpmn-tasks.adoc[leveloffset=+2]
include::modules/bpmn/ref-bpmn-subprocesses.adoc[leveloffset=+2]
include::modules/bpmn/ref-bpmn-gateways.adoc[leveloffset=+2]
include::modules/bpmn/ref-bpmn-connectors.adoc[leveloffset=+2]
include::modules/bpmn/proc-bpmn-model-creating.adoc[leveloffset=+1]
include::modules/bpmn/con-bpmn-variables.adoc[leveloffset=+1]
include::modules/bpmn/proc-bpmn-variables-global.adoc[leveloffset=+2]
include::modules/bpmn/proc-bpmn-variables-process.adoc[leveloffset=+2]
include::modules/bpmn/proc-bpmn-variables-local.adoc[leveloffset=+2]
...
include::modules/bpmn/con-bpmn-process-management-addon.adoc[leveloffset=+1]
include::modules/bpmn/con-management-console.adoc[leveloffset=+1]
include::modules/bpmn/proc-management-console-using.adoc[leveloffset=+2]
